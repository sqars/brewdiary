...
func Init(db *gorm.DB) *mux.Router {
	...
	r.HandleFunc("/brew/{id:[0-9]+}/fermentation", brewHandler.AddFermentation).Methods("PUT")
	r.HandleFunc("/brew/{id:[0-9]+}/fermentation", brewHandler.UpdateFermentation).Methods("PATCH")
